...
Lemma StartServiceIsInvariant : forall (s s':System) (sValid:validstate s) (intt:Intent) (ic:iCmp), pre_startService intt ic s -> post_startActivity intt ic s s' -> validstate s'.
Proof.
    intro.
    intro.
    intro.
